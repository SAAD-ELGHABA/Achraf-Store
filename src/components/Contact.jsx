...
function Contact() {
  ...
  return (
    <div className="py-28 md:flex container m-auto">

      <div className="md:w-2/3 grid place-items-center ">
      <form className="w-3/4 mx-auto ">
        ...
        <div className="grid md:grid-cols-2 md:gap-6">
          ...
          <div className="relative z-0 w-full mb-5 group">
            <textarea name="floating_msg" id="floating_msg" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-red-600 focus:outline-none focus:ring-0 focus:border-red-600 peer" placeholder=" " minLength={50} required > 
            </textarea>
        ...
        <button type="submit" className="my-5  md:w-1/2 w-full self-center  border py-2 rounded hover:bg-slate-50 hover:text-slate-950">Submit</button>
      </form>
      </div>
      <div className="md:w-1/4 justify-center flex relative">
        <img src="src/assets/email-picture.jpg" alt="email-picture" className="w-full rounded-lg " />
        <div className="absolute brightness-50 p-5 -bottom-5 right-3 left-3 text-sm text-slate-50 rounded-lg bg-slate-950 border">
            You can contact us throught our number : 000000000009
        </div>
      </div>
    </div>
  )
